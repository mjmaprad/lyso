...
//G4cout<<"first  "<<startPoint->GetPhysicalVolume()->GetName();//
 //G4cout<<" end   "<<endPoint->GetPhysicalVolume()->GetName()<<"   "<<G4endl;
	    ...
	    if( 
        (startPoint->GetPhysicalVolume()->GetName()== "fFoil")//||startPoint->GetPhysicalVolume()->GetName()== "world_PV")
     ...
     runData->SetEntTotenergy(startPoint->GetKineticEnergy()/keV);
      ...
      &&((endPoint->GetPhysicalVolume()->GetName() == "fFoil")||(endPoint->GetPhysicalVolume()->GetName() == "world_PV"))
